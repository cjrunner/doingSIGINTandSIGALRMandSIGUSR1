...
class SI {
private:
       static const int NumberOfSignals=32;
// Note the lack of an equal sign: A c++ feature for initializing arrays. Don't try this with C, though!
    sigInfo si[NumberOfSignals]  {
        {0, "SIG???", "????","There is no signal number of 0"}, \
        {1, "SIGHUP","terminate process","terminal line hangup"}, \
        {2, "SIGINT","terminate process","interrupt program"}, \
        {3, "SIGQUIT","create core image","quit program"}, \
        {4, "SIGILL","create coreimage","illegal instruction"}, \
